...
namespace Checkpoints
{
   ...
   //     ( 99999, uint256("0x27fd5e1de16a4270eb8c68dee2754a64da6312c7c3a0e99a7e6776246be1ee3f"))
    ...
    // LFCoin: synchronized checkpoint (centrally broadcasted)
    ...
    // LFCoin: get last synchronized checkpoint
    ...
    // LFCoin: only descendant of current sync-checkpoint is allowed
    ...
    // LFCoin: reset synchronized checkpoint to last hardened checkpoint
...
// LFCoin: sync-checkpoint master key
...
// LFCoin: verify signature of sync-checkpoint message
...
// LFCoin: process synchronized checkpoint
