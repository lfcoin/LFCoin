...
// Copyright (c) 2014 The LefoStock developers
...
// for both LefoStockd and LefoStock(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of LefoStock releases, the client name should be selected from
