 ...
 * The LFCoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("LefoStock Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a LFCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/peerunity_tooltip"), tr("&About LefoStock"), this);
    aboutAction->setToolTip(tr("Show information about LFCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
   // aboutQtAction = new QAction(tr("About &Qt"), this);
 //   aboutQtAction->setToolTip(tr("Show information about Qt"));
 //   aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for LefoStock"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peerunity_tooltip"), tr("Show/Hide &LefoStock"), this);
    toggleHideAction->setToolTip(tr("Show or hide the LefoStock window"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("LefoStock client"));
    trayIcon->setIcon(QIcon(":/icons/peerunity_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LFCoin network", "", count));
}
