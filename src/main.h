...
static const int COINBASE_MATURITY_LFS = 100;
...
static const int64 PROOF_OF_WORK_BLOCKS = 500; // peershares: Block height of the last proof of work block
static const int64 IPO_SHARES = 50000000 * COIN; // peershares: Total number
...
static const uint256 hashGenesisBlockOfficial("0x00000b4777b01c0b92462e04996a34d7b32cbe6cbf018b457d7fe884683c3378");
...
public:
    ...
    {
        // LFCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // LFCoin: get transaction coin age
...
public:
    ...
    // LFCoin: block signature - signed by coin base txout[0]'s owner
    ...
    // LFCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // LFCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // LFCoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // LFCoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // LFCoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // LFCoin: block index flags
    enum  
    {
