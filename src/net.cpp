...
// Copyright (c) 2011-2015 The LFCoin developers
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LFCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are LFCoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"seed", "seed.1g.hk"},
  //  {"seedLFS", "seedLFS.LFCoin.net"},
  //  {"7server", "LFSseed.ns.7server.net"},
  //  {"altcointech", "dnsseed.LFS.altcointech.net"},
  //  {"diandianbi", "seed.diandianbi.org"},
  //  {"tnseed", "tnseed.LFCoin.net"},
   // {"tnseedLFS", "tnseedLFS.LFCoin.net"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // LFCoin enables dns seeding with testnet too
    {
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer.  LefoStock is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // LFCoin: mint proof-of-stake blocks in the background
